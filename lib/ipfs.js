        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("form", { onSubmit: this.handleSubmit },
                React.createElement("label", null,
                    "API Key:",
                    React.createElement("input", { type: "text", value: this.state.api, onChange: this.handleChange1 })),
                React.createElement("br", null),
                React.createElement("label", null,
                    "API Secret Key:",
                    React.createElement("input", { type: "text", value: this.state.api_secret, onChange: this.handleChange2 })),
                React.createElement("br", null),
                React.createElement("button", { type: "submit", value: "Submit" }, "Save Key")),
            React.createElement("br", null),
            React.createElement("label", null,
