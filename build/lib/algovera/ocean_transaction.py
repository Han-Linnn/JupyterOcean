...
ocean = Ocean(d)
# OCEAN = BToken(ocean.web3, ocean.OCEAN_address)
...
class OceanMarket():
    ...
    #     print(f"wallet ocean = {OCEAN.balanceOf(self.wallet.address)}")
    ...
    #     assert OCEAN.balanceOf(self.wallet.address) > 0, "need ganache OCEAN"
